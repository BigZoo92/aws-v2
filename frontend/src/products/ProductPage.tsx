...
export default function ProductPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setLoading(true);
    postComment(product.id, user.id, comment)
      .then((newComment) => {
  ...
  return (
    ...
    >
      ...
      <form
        ...
        style={{ display: 'flex', gap: 8, marginTop: 32, marginBottom: 16 }}
      >
        <Input
      ...
      <div>
        ...
        {!loading && sortedComments.length === 0 && (
          <div style={{ color: '#888', fontSize: 14 }}>Aucun commentaire pour ce produit.</div>
        )}
